...
${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNO_GL -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/stewart-platform/configure.o: stewart-platform/configure.cpp 
	${MKDIR} -p ${OBJECTDIR}/stewart-platform
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNO_GL -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stewart-platform/configure.o stewart-platform/configure.cpp

${OBJECTDIR}/stewart-platform/demo.o: stewart-platform/demo.cpp 
	${MKDIR} -p ${OBJECTDIR}/stewart-platform
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNO_GL -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stewart-platform/demo.o stewart-platform/demo.cpp

${OBJECTDIR}/stewart-platform/matrix.o: stewart-platform/matrix.cpp 
	${MKDIR} -p ${OBJECTDIR}/stewart-platform
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNO_GL -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stewart-platform/matrix.o stewart-platform/matrix.cpp

${OBJECTDIR}/stewart-platform/optimise.o: stewart-platform/optimise.cpp 
	${MKDIR} -p ${OBJECTDIR}/stewart-platform
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNO_GL -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stewart-platform/optimise.o stewart-platform/optimise.cpp

${OBJECTDIR}/stewart-platform/parse.o: stewart-platform/parse.cpp 
	${MKDIR} -p ${OBJECTDIR}/stewart-platform
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNO_GL -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stewart-platform/parse.o stewart-platform/parse.cpp

${OBJECTDIR}/stewart-platform/shapes.o: stewart-platform/shapes.cpp 
	${MKDIR} -p ${OBJECTDIR}/stewart-platform
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNO_GL -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stewart-platform/shapes.o stewart-platform/shapes.cpp

${OBJECTDIR}/stewart-platform/solve.o: stewart-platform/solve.cpp 
	${MKDIR} -p ${OBJECTDIR}/stewart-platform
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNO_GL -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stewart-platform/solve.o stewart-platform/solve.cpp

${OBJECTDIR}/stewart-platform/vector.o: stewart-platform/vector.cpp 
	${MKDIR} -p ${OBJECTDIR}/stewart-platform
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNO_GL -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stewart-platform/vector.o stewart-platform/vector.cpp
